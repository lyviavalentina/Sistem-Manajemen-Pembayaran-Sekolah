...
if(isset($_POST['simpan'])){
    ...
    $query = "UPDATE admin SET nama_admin = '$nama_admin', user_admin = '$user_admin', 
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                    <img width="100%" height="100%" src="img/logos.jpg">
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post" action="">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autocomplete="off" required name="nama_admin" class
                                                ="form-control form-control-user"
                                                    id="exampleInputEmail" aria-describedby="emailHelp"
                                                    placeholder="Enter Name..." value="<?= $res['nama_admin'] ?? '' ?>">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" autocomplete="off" required name="user_admin" class
                                                ="form-control form-control-user"
                                                    id="exampleInputEmail" aria-describedby="emailHelp"
                                                    placeholder="Enter Username..." value="<?= $res['user_admin'] ?? '' ?>">
                                            </div>
                                            <div class="form-group">
                                                <input autocomplete="off" type="password"required name="pass_admin"
                                                class="form-control form-control-user"
                                                    id="exampleInputPassword" placeholder="Password" value="<?= $res['pass_admin']?>">
                                            </div>
