...
<html lang="en">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scalr=1, shrink-to-fit=no">
        <meta name="description" content="">
        <meta name="author" content="">

        <title>Login</title>
        <link href="foto/logos.jpg" rel="icon" type="images/x-icon">
    ...
    <body class="bg-gradient-primary">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post" action="">
                                            <div class="form-group">
                                                <input type="text" autocomplete="off" required name="user" class
                                                ="form-control form-control-user"
                                                    id="exampleInputEmail" aria-describedby="emailHelp"
                                                    placeholder="Enter Username...">
                                            </div>
                                            <div class="form-group">
                                                <input autocomplete="off" type="password"required name="pass"
        ...
        <!--Core plugin JavScript-->
        <script src="vendor/jquery-easing/jquery.easing.min.js"></script>

        <!--Costom scripts for all pages-->
